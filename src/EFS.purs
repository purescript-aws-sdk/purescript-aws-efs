...
createFileSystem = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "createFileSystem"
...
createMountTarget = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "createMountTarget"
...
deleteFileSystem = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "deleteFileSystem"
...
deleteMountTarget = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "deleteMountTarget"
...
describeFileSystems = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "describeFileSystems"
...
describeMountTargetSecurityGroups = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "describeMountTargetSecurityGroups"
...
describeMountTargets = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "describeMountTargets"
...
modifyMountTargetSecurityGroups = Request.request service method  where
    service = Request.ServiceName "EFS"
    method = Request.MethodName "modifyMountTargetSecurityGroups"
